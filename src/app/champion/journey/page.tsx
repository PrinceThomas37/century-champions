  ...
  return (
    <main className="mx-auto min-h-screen max-w-md bg-steel-50 pb-24">
      <header className="flex items-center justify-between bg-ink px-5 py-4">
        ...
        <h1 className="text-sm font-bold uppercase tracking-wide text-white">Activity</h1>
        <form action="/api/auth/logout" method="post">
          <button className="text-xs font-semibold uppercase tracking-wide text-white/60">
            Log out
          </button>
        </form>
      </header>
